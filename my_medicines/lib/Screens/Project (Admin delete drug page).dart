        ...
        children: [
          Column(
            children: [
              ...
              Container(
                width: 280,
                child: Text('Enter the medication whose information you want to delete' , style: TextStyle(fontSize: 20 , fontWeight: FontWeight.bold) , textAlign: TextAlign.center,),
              ),
