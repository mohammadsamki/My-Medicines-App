...
void main(){
  runApp(UpdateDrugName());
}

class UpdateDrugName extends StatelessWidget {
        ...
        children: [
          Column(
            children: [
              ...
              Container(
                child: Text('Enter new name' , style: TextStyle(fontWeight: FontWeight.bold , fontSize: 20),),
              ),
                    ...
                    if(_formKey.currentState!.validate()){
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) => CupertinoAlertDialog(
                          ...
                          content: Text('Do you want to change this name?'),
                          actions: [
                            TextButton(
                            ...
                            TextButton(
                              onPressed: (){
                                showDialog(
                                  context: context,
                                  builder: (BuildContext context) => CupertinoAlertDialog(
                                    title: Text('The name has been changed'),
